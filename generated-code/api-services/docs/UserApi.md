...
let user = new SwaggerPetstore.User(); // User | Created user object
...
let apiInstance = new SwaggerPetstore.UserApi();
let user = [new SwaggerPetstore.User()]; // [User] | List of user object
...
let user = new SwaggerPetstore.User(); // User | Updated user object
